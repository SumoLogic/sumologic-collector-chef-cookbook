...
# DEB
default['sumologic']['collectorDEBUrl'] = node['kernel']['machine'] == 'aarch64' ? 'https://download-collector.sumologic.com/rest/download/deb/aarch/64' : 'https://download-collector.sumologic.com/rest/download/deb/64'
